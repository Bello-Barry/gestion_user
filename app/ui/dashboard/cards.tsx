  ...
  return (
    <>
      {/* NOTE: comment in this code when you get to this point in the course */}
       ...
       <Card title="Collecter" value={totalPaidInvoices} type="collected" />
      <Card title="En instance" value={totalPendingInvoices} type="pending" />
    ...
    <div className="rounded-xl bg-slate-700 p-2 shadow-sm">
      ...
      <p
        className={`${lusitana.className}
          truncate rounded-xl bg-slate-300 px-4 py-8 text-center text-2xl`}
      >
        {value}
      </p>
    </div>
